  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials, req) {
        ...
        // Check if user has a valid subscription or beta access (deny login if canceled)
        if (usePrisma && user.id) {
          ...
          if (!activeSub && !betaAccess) {
            // No active subscription or beta access - account is inactive
