...
// Optimized connection pool configuration for Vercel serverless
// Vercel functions are ephemeral, so we need smaller pools that don't waste connections
const pool = new Pool({ 
  connectionString: process.env.DATABASE_URL,
  max: 5,                           // Reduced from 20 - Vercel functions are short-lived
  idleTimeoutMillis: 10000,         // Close idle connections after 10s (was 30s)
  connectionTimeoutMillis: 5000,    // Fail fast on timeout (was 10s)
