// lib/ai.js - Resilient AI adapter with Hugging Face → OpenAI → Template fallbacks
 ...
 * 1. Hugging Face Inference API (free, with 15s timeout)
 * 2. OpenAI gpt-4o-mini (with 10s timeout)
 * 3. Enhanced template-based fallback that mimics AI behavior
 * 
...
async function generateCompletion({ prompt, temperature = 0.5, maxTokens = 1500, type = 'text', context = {} }) {
  ...
  // Try Hugging Face Inference API (free) FIRST with 15s timeout
