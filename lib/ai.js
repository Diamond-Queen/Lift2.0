// lib/ai.js - Resilient AI adapter with OpenAI → Anthropic → Hugging Face → Template fallbacks
 ...
 * 3. Hugging Face Inference API (free, with 15s timeout)
 * 4. Template-based fallback (for career/notes)
 * 
...
async function generateCompletion({ prompt, temperature = 0.5, maxTokens = 1500, type = 'text', context = {} }) {
  ...
  // Try Hugging Face Inference API (free) with 15s timeout
