...
CREATE TABLE "SchoolCode" (
    ...
    CONSTRAINT "SchoolCode_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "SchoolCode" ADD CONSTRAINT "SchoolCode_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "School"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
